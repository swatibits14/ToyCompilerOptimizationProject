CC = gcc
CFLAGS = -w -g
DEPS = compiler.o DFA.o  follow.o HashTable.o first.o lexer.o linklist.o parser.o set.o Tree.o AST.o gvl.o myIRgenerator.o myOptimizer.o myCodeGenerator.o codeGenerator.o SymbolTable.o typeChecker.o driver.o 
...
myIRgenerator.o: myIRgenerator.h myIRgenerator.c 
	$(CC) $(CFLAGS) -c myIRgenerator.c

myOptimizer.o: myOptimizer.h myOptimizer.c 
	$(CC) $(CFLAGS) -c myOptimizer.c

myCodeGenerator.o: myCodeGeneratorDef.h myCodeGenerator.c myCodeGenerator.h
	$(CC) $(CFLAGS) -c myCodeGenerator.c
